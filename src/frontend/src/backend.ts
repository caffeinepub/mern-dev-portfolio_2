...
export class Backend implements backendInterface {
    ...
    async getNextId(): Promise<Principal> {
    ...
    async getSortedContactMessages(): Promise<Array<ContactMessage>> {
        if (this.processError) {
            try {
                const result = await this.actor.getSortedContactMessages();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async trap(): Promise<{
        ...
        if (this.processError) {
            try {
                const result = await this.actor.trap();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
